...
- (void)configCustomNaviBar {
    ...
    [_backButton setImage:imageNamed(@"navi_back") forState:UIControlStateNormal];
    [_backButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_backButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
    if(_isCanSelect){
        _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.tz_width - 54, 10, 42, 42)];
        [_selectButton setImage:imageNamed(@"photo_def_photoPickerVc") forState:UIControlStateNormal];
        [_selectButton setImage:imageNamed(@"photo_sel_photoPickerVc")  forState:UIControlStateSelected];
...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:imageNamed(@"preview_original_def") forState:UIControlStateNormal];
        [_originalPhotoButton setImage:imageNamed(@"photo_original_sel") forState:UIControlStateSelected];
    ...
    if(_isCanSelect){
        ...
        _numberImageView = [[UIImageView alloc] initWithImage:imageNamed(@"photo_number_icon")];
