...
- (void)viewDidLoad {
    ...
    [backButton setImage:imageNamed(@"icon_arrow2") forState:UIControlStateNormal];
...
{
    _tzImagePickerVc.selectedAssets = nil;
...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:imageNamed(@"photo_original_def") forState:UIControlStateNormal];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row >= _photoArr.count) {
        ...
        cell.imageView.image = imageNamed(@"takePicture");
        return cell;
    }
