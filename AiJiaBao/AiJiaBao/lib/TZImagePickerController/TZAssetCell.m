...
- (void)setModel:(TZAssetModel *)model {
    ...
    self.selectImageView.image = self.selectPhotoButton.isSelected ? imageNamed(@"photo_sel_photoPickerVc") :imageNamed(@"photo_def_photoPickerVc");
...
- (void)selectPhotoButtonClick:(UIButton *)sender {
    ...
    self.selectImageView.image = sender.isSelected ?imageNamed(@"photo_sel_photoPickerVc"): imageNamed(@"photo_def_photoPickerVc");
