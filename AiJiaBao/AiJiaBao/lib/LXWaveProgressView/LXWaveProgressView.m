...
#define LXDefaultFirstWaveColor [UIColor colorWithRed:105.0/255.0 green:212.0/255.0 blue:250.0/255.0 alpha:1]
#define LXDefaultTextColoe [UIColor colorWithRed:91.0/255.0 green:196.0/255.0 blue:243.0/255.0 alpha:1]
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.layer.borderColor = [UIColor colorWithRed:80.0/255.0 green:198.0/255.0 blue:231.0/255.0 alpha:1].CGColor;
...
-(void)setProgress:(CGFloat)progress
{
    ...
    _progressLabel.textColor=LXDefaultTextColoe;
