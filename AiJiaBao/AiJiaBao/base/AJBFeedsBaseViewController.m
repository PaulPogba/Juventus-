...
#import "AJBFeedsBaseViewController.h"
...
@interface AJBFeedsBaseViewController ()
...
@property (nonatomic,assign) BOOL displaysAsynchronously;//是否异步


@end

@implementation AJBFeedsBaseViewController
...
//    JSONTestObj *object = [JSONTestObj mj_objectWithKeyValues:response[indexPath.row]];
//    NSArray *ARROR = [[NSArray alloc] init];
//    [response  objectAtIndex:<#(NSUInteger)#>];
...
- (NSArray *)fakeDatasource {
    ...
    @[
      ...
      @{@"type":@"image",
        ...
        @"content":@"Austin Butler & Vanessa Hudgens  想试试看扑到一个一米八几的人怀里是有多舒服",
        @"date":@"1459668442",
